...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_json_viewer__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_vue_json_viewer___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_vue_json_viewer__);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        'v-json-viewer': __WEBPACK_IMPORTED_MODULE_0_vue_json_viewer___default.a
    },
    data: function data() {
        return {
            draft: null,
    ...
    methods: {
        getVersionDiff: function getVersionDiff() {
            var _this = this;

            Nova.request().get('/nova-vendor/version-difference-viewer/index').then(function (response) {
                _this.changes = response.data.changes;
                _this.draft = response.data.draft;
                _this.published = response.data.draft.parent;
            }).catch(function (error) {
                console.log(error);
            });
        },
        formatModelName: function formatModelName(model) {
            var spilt = model.split('\\');
            return spilt[2];
        }
    }
});
...
var render = function() {
  ...
  return _vm.changes.length
    ? _c(
        "div",
        [
          _c("heading", { staticClass: "text-2xl mb-6" }, [
            _vm._v("\n        Version Difference Viewer\n    ")
          ]),
          _vm._v(" "),
          _c("header", { staticClass: "text-2xl mb-6 mt-4" }, [
            _vm._v("\n        From "),
            _c("label", { staticClass: "text-primary" }, [
              _vm._v(" Version " + _vm._s(_vm.published.version))
            ]),
            _vm._v(" To "),
            _c("label", { staticClass: "text-success" }, [
              _vm._v(" Version " + _vm._s(_vm.draft.version) + " ")
            ])
          ]),
          _vm._v(" "),
          _c("div", { staticClass: "container bg-white" }, [
            _c(
              ...
              [
                _c(
                  "table",
                  { staticStyle: { "border-spacing": "0 0.75rem" } },
                  [
                    _vm._m(0),
                    _vm._v(" "),
                    _c(
                      ...
                      _vm._l(_vm.changes, function(change) {
                        return _c("tr", [
                          _c("td", { staticClass: "border px-4 py-2" }, [
                            _vm._v(
                              _vm._s(_vm.formatModelName(change.model_type))
                            )
                          ]),
                          _vm._v(" "),
                          _c(
                            "td",
                            { staticClass: "capitalize border px-4 py-2" },
                          ...
                          _c(
                            "td",
                            { staticClass: "border px-4 py-2 w-1/4" },
                            [
                              _c("v-json-viewer", {
                                attrs: { value: change.original, boxed: "" }
                              })
                            ],
                            1
                          ),
                          ...
                          _c(
                            ...
                            [
                              _c("v-json-viewer", {
                                attrs: { value: change.changes, boxed: "" }
                              })
                            ],
                            1
                          )
    ...
    : _c(
        ...
        [
          _c(
            "heading",
            { staticClass: "text-2xl mb-6 text-center text-black" },
            [
              _vm._v(
...
var staticRenderFns = [
  function() {
    ...
    return _c("thead", [
      _c("tr", [
        _c("th", { staticClass: "border px-4 py-2" }, [_vm._v("Entity")]),
        _vm._v(" "),
        _c("th", { staticClass: "border px-4 py-2" }, [_vm._v("User")]),
        _vm._v(" "),
        _c("th", { staticClass: "border px-4 py-2" }, [_vm._v("Action")]),
        _vm._v(" "),
        _c("th", { staticClass: "border px-4 py-2" }, [_vm._v("Original")]),
        _vm._v(" "),
        _c("th", { staticClass: "border px-4 py-2" }, [_vm._v("Changes")])
      ])
    ])
  }
]
